...
const TOOL_SCOPES: Record<string, AuthScope> = {
  ...
  semfs_get_budget_posture: "governance:read",
  ...
  semfs_record_knowledge_draft: "context:write",
  semfs_record_research_source: "context:write",
  semfs_record_capability_gap: "evolution:write",
  semfs_create_capability_proposal: "evolution:write",
  semfs_promote_knowledge_draft: "approval:write",
  semfs_resolve_review_packet: "approval:write",
  semfs_link_approval_to_artifact: "approval:write",
  semfs_create_credential_binding_request: "review:write",
  semfs_apply_voice_profile_update: "identity:profile_write",
  semfs_apply_domain_context: "identity:profile_write",
  semfs_apply_offer_catalog_update: "identity:profile_write",
  semfs_activate_agent: "activation:write",
  semfs_activate_route: "activation:write",
};
